<table class="border-collapse table-auto w-full text-sm">
    ...
    <tbody wire:sortable="updateSongOrder" wire:sortable.options='{ animation: 500, easing: "cubic-bezier(1, 0, 0, 1)"}' class="bg-white">
    @foreach ($songs as $song)
        <tr wire:sortable.item="{{ $song->id }}" wire:key="song-{{ $song->id }}" >
            ...
            <td class="border-b border-slate-200 p-4 text-slate-500">{{ $song->author }}</td>
